          ...
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-gray-600">
                With seven strategic locations throughout the Northeast, we're positioned to serve clients with local expertise and resources.
              </p>
            </div>
          </AnimatedSection>
  ...
  >
    {name === "Facebook" && (
      <img
        ...
        alt="Facebook logo"
        className="w-5 h-5 bg-transparent border-none outline-none"
      />
    )}
    {name === "LinkedIn" && (
      <img
