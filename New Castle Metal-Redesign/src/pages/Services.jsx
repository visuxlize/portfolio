...
import { Check, ArrowRight, Settings, Home, Wrench, Layers, Database, FileText } from 'lucide-react';
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 bg-primary text-white overflow-hidden">
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1606942040878-9a852c5045a3?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwzfHxtZXRhbCUyMHJvb2ZpbmclMjBjb21tZXJjaWFsJTIwYnVpbGRpbmclMjBhcmNoaXRlY3R1cmUlMjBibHVlJTIwc2t5fGVufDB8fHx8MTc0MzQzODgwMXww&ixlib=rb-4.0.3&fit=fillmax&h=1080&w=1920"
