  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 bg-primary text-white">
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1654331045702-405756aba4ab?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHw0fHxtZXRhbCUyMHJvb2ZpbmclMjBjb21tZXJjaWFsJTIwYnVpbGRpbmclMjBhcmNoaXRlY3R1cmUlMjBibHVlJTIwc2t5fGVufDB8fHx8MTc0MzQzODgwMXww&ixlib=rb-4.0.3&fit=fillmax&h=1080&w=1920"
          ...
          <AnimatedSection>
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-gray-200 mb-6">
                With seven strategic locations across the Northeast, we're positioned to serve clients efficiently with local expertise.
              </p>
            </div>
          </AnimatedSection>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="flex items-start">
                          <Clock size={18} className="mr-2 text-accent flex-shrink-0 mt-1" />
                          <span className="text-gray-700">{selectedLocation.hours}</span>
                        </p>
                        <p className="flex items-start">
                          <Clock size={18} className="mr-2 text-accent flex-shrink-0 mt-1" />
                          <span className="text-gray-700">{selectedLocation.closed}</span>
                        </p>
                      </div>
                    </div>
                    <div>
