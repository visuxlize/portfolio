  ...
  const productCategories = [
    {
      ...
      image: "https://images.unsplash.com/photo-1597361819042-e65629dca1ba?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwxfHxtZXRhbCUyMHJvb2ZpbmclMjBzdGFuZGluZyUyMHNlYW0lMjBjb21tZXJjaWFsfGVufDB8fHx8MTc0MzI4NTU2MHww&ixlib=rb-4.0.3&fit=fillmax&h=800&w=1200",
      features: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1501166222995-ff31c7e93cef?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwzfHxtZXRhbCUyMHJvb2ZpbmclMjBzdGFuZGluZyUyMHNlYW0lMjBjb21tZXJjaWFsfGVufDB8fHx8MTc0MzI4NTU2MHww&ixlib=rb-4.0.3&fit=fillmax&h=800&w=1200",
      features: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1519310572353-9536984a4b0b?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHw0fHxtZXRhbCUyMHJvb2ZpbmclMjBzdGFuZGluZyUyMHNlYW0lMjBjb21tZXJjaWFsfGVufDB8fHx8MTc0MzI4NTU2MHww&ixlib=rb-4.0.3&fit=fillmax&h=800&w=1200",
      features: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1593153041370-5ebf6b82886a?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwyfHxtZXRhbCUyMHJvb2ZpbmclMjBzdGFuZGluZyUyMHNlYW0lMjBjb21tZXJjaWFsfGVufDB8fHx8MTc0MzI4NTU2MHww&ixlib=rb-4.0.3&fit=fillmax&h=800&w=1200",
      features: [
        "Multiple profile options",
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <ul className="text-gray-600 space-y-1">
                    <li>• Galvanized Steel (24ga - 22ga)</li>
                    <li>• Aluminum (.032" - .050")</li>
                    <li>• Zinc (.7mm - 1.5mm)</li>
                    <li>• Copper (16oz - 20oz)</li>
                    <li>• Stainless Steel (24ga - 22ga)</li>
                  </ul>
                </div>
          ...
          <AnimatedSection>
            <div className="flex flex-col md:flex-row md:items-center justify-between">
              ...
              <div className="md:flex-shrink-0 flex flex-col space-y-4">
                ...
                <Link to="/colors-finishes" className="btn border-white text-white bg-transparent hover:bg-white hover:text-primary whitespace-nowrap">
