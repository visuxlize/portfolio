...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Phone",
      value: "+1 (929) 736-5266",
      link: "tel:+19297365266"
    },
    {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://visuxlize.github.io/portfolio/",
  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-br from-secondary-50 to-white">
