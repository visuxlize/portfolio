...
import andresImage from '../andres.jpg';
  ...
  const education = [
    {
      ...
      year: "2024 - 2027",
      description: "Focusing on network security, and secure software development."
    },
    {
      degree: "Bachelors of Architectural Technology",
      school: "New York City College of Technology",
      year: "2014 - 2019",
      description: "Intensive program covering Architectural Technology."
    }
  ];
            ...
            <div className="relative">
              <div className="w-80 h-80 mx-auto relative">
                ...
                <div className="absolute inset-2 bg-white rounded-2xl overflow-hidden">
                  <img src={andresImage} alt="Andres Marte" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
